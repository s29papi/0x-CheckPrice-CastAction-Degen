...
export async function GET(req: NextRequest) {
  ...
  return new ImageResponse(
    (
      <div>Hello</div>
      // <div>
      //     <Image width={1000} height={500} src="http://localhost:3001/base.png" alt="Image Background of Search frame" />
      // </div>
     
      // <div tw="flex w-[800px] h-[420px]" >
      //   <div tw="flex relative">
      //        {/* <img tw="w-full h-full" src="http://localhost:3001/photo_2024-02-17_03-31-57.png" /> */}
      //        <Image tw="w-full h-full" src={backGroundFrame} alt="Image Background of Search frame" />
